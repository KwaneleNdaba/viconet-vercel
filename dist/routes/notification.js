        ...
        try {
            notifications.map((notification) => __awaiter(this, void 0, void 0, function* () {
                if (notification.type == "0") {
                    const emailText = (0, emailService_1.addToProjectTemplate)(notification.userName, `https://viconet-dev.netlify.app/protected/profile/notifications?id=${notification.targetUser}`);
                    const sendEmail = yield (0, emailService_1.sendMail)(notification.email, "New project invite", `You have been invited to a new project, you can accept/decline here:${notification.targetUser}`, emailText);
